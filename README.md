<div>
      <div>
        ...
        <div>
            <img width="100%" height="10%" src="https://erjyotigoswami9.github.io/assets/paymentImage-CuomXJ5l.png" alt="project-img"/>
        </div>
        <div>
            <h3>
              Tech Stacks
            ...
            <p>
                ...
                <ul>
                    <li>User Details display</li>
                    <li>Navigation between pages</li>
                    <li>Payment amount and message display</li>
        ...
        <div>
            <a href="https://github.com/erjyotigoswami9/paymentInterface" target="_blank">
            <div>
            ...
            <a href="https://payment-interface-gamma.vercel.app/" target="_blank">
            <div>
